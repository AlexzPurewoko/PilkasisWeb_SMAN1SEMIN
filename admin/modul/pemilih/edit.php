			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Form Edit Pemilih</h3>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
						<?php
						...
						?>
						<!--Mulai buat form-->
						<form action="?m=pemilih&s=update" method="post" enctype="multipart/form-data">
							<table id="pilkasis1" class="table table-bordered table-hover table-striped">
								<tbody>
									...
									<tr>
										...
										<td>
											<select name="id_group">
												<?php
												$sql2 = "SELECT * FROM groups ORDER BY nama_group";
									...
									<tr>
										<td>Aktifkan</td>
										<td><input type="radio" name="aktif" id="aktifY" value="Yes" <?php if ($r['activated'] == 'Yes') echo " checked"; ?> />Ya &nbsp;&nbsp;
											<input type="radio" name="aktif" id="aktifT" value="No" <?php if ($r['activated'] == 'No') echo " checked"; ?> />Tidak</td>
									</tr>
									<tr>
										<td colspan=3>
