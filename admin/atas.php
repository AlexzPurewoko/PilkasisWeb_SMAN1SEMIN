            ...
            <ul class="nav navbar-nav">
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="../gambar/pengguna/<?php echo $_SESSION['admin_id']; ?>" class="user-image" alt="<?php echo $_SESSION['nis']; ?>">
                  <span class="hidden-xs"><?php echo $_SESSION['admin_username']; ?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="../gambar/pengguna/<?php echo $_SESSION['admin_images']; ?>" class="img-circle" alt="<?php echo $_SESSION['nis']; ?>">
                    <p>
                      <?php echo $_SESSION['admin_name']; ?>
                      <small><?php echo $_SESSION['admin_jobs']; ?></small>
                    </p>
                  </li>
                  <!-- Menu Footer-->
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="../gambar/pengguna/<?php echo $_SESSION['admin_images']; ?>" class="img-circle" alt="<?php echo $_SESSION['admin_username']; ?>">
            </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?php if($aktif=='Kelompok') echo 'active';?> treeview">
              <a href="#">
                <i class="fa fa-graduation-cap"></i> <span>Kelompok</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="?m=kelompok"><i class="fa fa-list"></i> Daftar</a></li>
                <li><a href="?m=kelompok&s=tambah"><i class="fa fa-plus"></i> Tambah</a></li>
              </ul>
            </li>
            <li class="<?php if($aktif=='Pemilih') echo 'active';?> treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="?m=pemilih"><i class="fa fa-list"></i> Daftar</a></li>
                <li><a href="?m=pemilih&s=tambah"><i class="fa fa-user-plus"></i> Tambah</a></li>
              </ul>
            </li>
            ...
            <li class="<?php if($aktif=='Real Count') echo 'active';?> treeview">
              <a href="#">
                <i class="fa fa-laptop"></i>
              ...
              <ul class="treeview-menu">
                <li><a href="?m=real_count"><i class="fa fa-list"></i> Hasil Pemilihan</a></li>
              </ul>
            </li>
            <li>
              <a href="logout.php">
