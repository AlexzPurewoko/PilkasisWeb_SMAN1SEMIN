		...
		<footer class="main-footer">
		  ...
		  <strong> Edited @2019 by <a href="http://instagram.com/apwdevs" target="_blank">@APWDevs</a> Kenshiro(SMKN 1 Giritontro) from <a href="http://muhidin.web.id" target="_blank">SkillPro Programming</a>.</strong>
		</footer>
